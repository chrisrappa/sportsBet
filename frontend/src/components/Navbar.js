    ...
    <nav className="navbar z-10">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-16">
          ...
          {/* Mobile Menu Button */}
          <button onClick = {() => toggleMenu()} type="button" className="w-20 h-full z-10 inline-flex items-center justify-center rounded-md text-gray-400 md:hidden lg:hidden xl:hidden cursor-pointer focus:to-white ">
